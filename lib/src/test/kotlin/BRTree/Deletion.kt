...
class Deletion {
    ...
    fun deletion3() {
        val values= listOf(10,11,7,8,6,5)
        for (i in values)
            tree.insert(i, 0)
        tree.delete(8)
    ...
    fun blackDeletion4() {
        val values= listOf(10,5,20,15,25,23,17,28,12)
        for (i in values)
            tree.insert(i, 0)
        tree.delete(5)
    ...
    fun blackDeletion5() {
        val values= listOf(7,5,10,2,8,6,13,12,1,4,3)
        for (i in values)
            tree.insert(i, 0)
        tree.delete(6)
    ...
    fun blackDeletion6() {
        val values= listOf(7,5,10,2,8,6,13,1,12,15,14)
        for (i in values)
            tree.insert(i, 0)
        tree.delete(8)
    ...
    fun redDeletion4() {
        val values= listOf(20,10,30,5,15,25,8)
        for (i in values)
            tree.insert(i, 0)
        tree.delete(10)
